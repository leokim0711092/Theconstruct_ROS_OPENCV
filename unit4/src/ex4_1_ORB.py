...
image_1 = cv2.imread('/home/user/catkin_ws/src/unit4/Course_images/ROS.jpg',1)
image_2 = cv2.imread('/home/user/catkin_ws/src/unit4/Course_images/ROS2.jpg',1) 

image_1 = cv2.resize(image_1,(400,600))
image_2 = cv2.resize(image_2,(400,600))
